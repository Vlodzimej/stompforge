...
- [x] README states that users are responsible for selected model and IR
  licenses.
...
- [x] English documentation matches the release.
- [x] `CHANGELOG.md` matches the release notes.
